...
public class AuthenticationJsonWebTokenTest {
	...
	private AuthenticationJsonWebToken getMockedAuthJsonWebInstanceWithoutRoles() {
	...
	public void testGetAuthoritiesWithTokenThatHasNoRoles() {
		AuthenticationJsonWebToken authenticationJsonWebToken = getMockedAuthJsonWebInstanceWithoutRoles();
		assertNotNull(authenticationJsonWebToken.getAuthorities());
